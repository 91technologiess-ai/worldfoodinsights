          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-sm font-medium text-gray-500">Share:</span>
                ...
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(article.title)}&url=${encodeURIComponent(`https://worldfoodinsights.com/${article.slug}`)}`}
              ...
              >
                ...
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://worldfoodinsights.com/${article.slug}`)}`}
                target="_blank" rel="noopener noreferrer"
              ...
              >
                ...
                href={`https://api.whatsapp.com/send?text=${encodeURIComponent(article.title + " https://worldfoodinsights.com/" + article.slug)}`}
                target="_blank" rel="noopener noreferrer"
