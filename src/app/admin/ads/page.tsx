            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                {newAd.ad_type === "adsense" && (
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Go to Google AdSense → Ads → By ad unit → Display ads → copy the code
                    </p>
                  </div>
                )}
                ...
                {newAd.ad_type === "custom" && (
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1">Custom HTML Code</label>
                    <textarea
                      placeholder="<div>Your custom ad HTML here...</div>"
                      value={newAd.ad_code}
                      onChange={(e) => setNewAd(p => ({ ...p, ad_code: e.target.value }))}
                      rows={5}
                      className="w-full border border-gray-200 rounded-lg p-2.5 text-xs font-mono outline-none focus:border-yellow-400 resize-none"
                ...
                {zones.map((zone) => (
                  <div key={zone.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{zone.width}×{zone.height}px</p>
                    </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className={`text-xs px-2 py-0.5 rounded font-medium ${
                            ad.ad_type === "adsense" ? "bg-blue-100 text-blue-700" :
                            ad.ad_type === "image" ? "bg-purple-100 text-purple-700" :
